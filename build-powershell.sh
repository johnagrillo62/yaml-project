...
# Spec:   spec/yaml-peg-powershell.lisp
# ════════════════════════════════════════════════════════════════
...
do_check() {
  ...
  if [ -f spec/yaml-peg-powershell.lisp ]; then
    echo "  ✓ spec/yaml-peg-powershell.lisp ($(wc -l < spec/yaml-peg-powershell.lisp) lines)"
  else
    echo '  ✗ spec/yaml-peg-powershell.lisp not found'
