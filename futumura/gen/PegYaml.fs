...
and ns_esc_8_bit inp =
    pegSeq [
        (fun inp -> (matchCp 120 inp));
        (fun inp -> (rep 2 (fun inp -> (ns_hex_digit inp)) inp))] inp

// [60] NS-ESC-16-BIT 
and ns_esc_16_bit inp =
    pegSeq [
        (fun inp -> (matchCp 117 inp));
        (fun inp -> (rep 4 (fun inp -> (ns_hex_digit inp)) inp))] inp
...
and b_l_trimmed inp n c =
    pegSeq [
        ...
        (fun inp -> (plus_ (fun inp -> (l_empty inp n c)) inp))] inp
...
and c_ns_shorthand_tag inp =
    pegSeq [
        (fun inp -> (c_tag_handle inp));
        (fun inp -> (plus_ (fun inp -> (ns_tag_char inp)) inp))] inp
...
and c_ns_anchor_property inp =
    buildAst "ANCHOR" (fun inp -> (pegSeq [
        (fun inp -> (c_anchor inp));
        (fun inp -> (scalarFn (fun inp -> (ns_anchor_name inp)) inp))] inp)) inp
...
and s_double_next_line inp n =
    pegSeq [
        ...
        (fun inp -> (opt (fun inp -> (pegSeq [
            ...
            (fun inp -> (pegAlt [
                (fun inp -> (s_double_next_line inp n));
                (fun inp -> (star (fun inp -> (s_white inp)) inp))] inp))] inp)) inp))] inp
...
and nb_double_multi_line inp n =
    pegSeq [
        ...
        (fun inp -> (pegAlt [
            (fun inp -> (s_double_next_line inp n));
            (fun inp -> (star (fun inp -> (s_white inp)) inp))] inp))] inp
...
and s_single_next_line inp n =
    pegSeq [
        ...
        (fun inp -> (opt (fun inp -> (pegSeq [
            ...
            (fun inp -> (pegAlt [
                (fun inp -> (s_single_next_line inp n));
                (fun inp -> (star (fun inp -> (s_white inp)) inp))] inp))] inp)) inp))] inp
...
and c_b_block_header inp n =
    pegAlt [
        (fun inp -> (bindInt (fun inp -> pegAlt [
            (fun inp -> (parseIntFn (fun inp -> (ns_dec_digit inp)) inp));
            (fun inp -> (detectIndent n inp))] inp) (fun m -> fun inp -> bindCtx (fun inp -> pegAlt [
            (fun inp -> (parseSymFn (fun inp -> (matchCp 45 inp)) "STRIP" inp));
            (fun inp -> (parseSymFn (fun inp -> (matchCp 43 inp)) "KEEP" inp));
            (fun inp -> (valFn "CLIP" inp))] inp) (fun t -> fun inp -> s_b_comment inp) inp) inp));
        (fun inp -> (bindCtx (fun inp -> pegAlt [
            (fun inp -> (parseSymFn (fun inp -> (matchCp 45 inp)) "STRIP" inp));
            (fun inp -> (parseSymFn (fun inp -> (matchCp 43 inp)) "KEEP" inp));
            (fun inp -> (valFn "CLIP" inp))] inp) (fun t -> fun inp -> bindInt (fun inp -> pegAlt [
            (fun inp -> (parseIntFn (fun inp -> (ns_dec_digit inp)) inp));
            (fun inp -> (detectIndent n inp))] inp) (fun m -> fun inp -> s_b_comment inp) inp) inp))] inp
...
and c_lliteral inp n =
    pegSeq [
        ...
        (fun inp -> (bindInt (fun inp -> pegAlt [
            ...
            (fun inp -> (parseSymFn (fun inp -> (matchCp 45 inp)) "STRIP" inp));
            (fun inp -> (parseSymFn (fun inp -> (matchCp 43 inp)) "KEEP" inp));
            (fun inp -> (valFn "CLIP" inp))] inp) (fun t -> fun inp -> pegSeq [(fun inp -> (s_b_comment inp)); (fun inp -> (l_literal_content inp (n + m) t))] inp) inp) inp))] inp
...
and c_lfolded inp n =
    pegSeq [
        ...
        (fun inp -> (bindInt (fun inp -> pegAlt [
            ...
            (fun inp -> (parseSymFn (fun inp -> (matchCp 45 inp)) "STRIP" inp));
            (fun inp -> (parseSymFn (fun inp -> (matchCp 43 inp)) "KEEP" inp));
            (fun inp -> (valFn "CLIP" inp))] inp) (fun t -> fun inp -> pegSeq [(fun inp -> (s_b_comment inp)); (fun inp -> (l_folded_content inp (n + m) t))] inp) inp) inp))] inp
...
and lblock_sequence inp n =
    buildAst "SEQUENCE" (fun inp -> (bindInt (fun inp -> detectIndent n inp) (fun m -> fun inp -> collectFn (fun inp -> (plus_ (fun inp -> (pegSeq [(fun inp -> (s_indent inp (n + m))); (fun inp -> (c_l_block_seq_entry inp (n + m)))] inp)) inp)) inp) inp)) inp
...
and s_lblock_indented inp n c =
    pegAlt [
        (fun inp -> (bindInt (fun inp -> detectIndent 0 inp) (fun m -> fun inp -> pegSeq [
            (fun inp -> (s_indent inp m));
            (fun inp -> (pegAlt [
                (fun inp -> (ns_l_compact_sequence inp (n + 1 + m)));
                (fun inp -> (ns_l_compact_mapping inp (n + 1 + m)))] inp))] inp) inp));
...
and lblock_mapping inp n =
    buildAst "MAPPING" (fun inp -> (bindInt (fun inp -> detectIndent n inp) (fun m -> fun inp -> collectFn (fun inp -> (plus_ (fun inp -> (pegSeq [(fun inp -> (s_indent inp (n + m))); (fun inp -> (ns_l_block_map_entry inp (n + m)))] inp)) inp)) inp) inp)) inp
