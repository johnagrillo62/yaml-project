...
// [1] C-PRINTABLE
Res c_printable(Input inp) {
    return peg_alt(inp, 1, (PFn[]){
        ^Res(Input inp){ return match_cp(inp, 0x9); },
        ^Res(Input inp){ return match_cp(inp, 0x0A); },
        ^Res(Input inp){ return match_cp(inp, 0x0D); },
        ^Res(Input inp){ return match_range(inp, 0x20, 0x7E); },
        ^Res(Input inp){ return match_cp(inp, 0x85); },
        ^Res(Input inp){ return match_range(inp, 0xA0, 0xD7FF); },
        ^Res(Input inp){ return match_range(inp, 0xE000, 0xFFFD); },
...
Res c_reserved(Input inp) {
    return peg_alt(inp, 1, (PFn[]){
        ^Res(Input inp){ return match_cp(inp, 64); },
        ^Res(Input inp){ return match_cp(inp, 96); }});
}

// [22] C-INDICATOR
Res c_indicator(Input inp) {
    return peg_alt(inp, 1, (PFn[]){
        ^Res(Input inp){ return c_sequence_entry(inp); },
        ^Res(Input inp){ return c_mapping_key(inp); },
        ^Res(Input inp){ return c_mapping_value(inp); },
        ^Res(Input inp){ return c_collect_entry(inp); },
        ^Res(Input inp){ return c_sequence_start(inp); },
        ^Res(Input inp){ return c_sequence_end(inp); },
        ^Res(Input inp){ return c_mapping_start(inp); },
        ^Res(Input inp){ return c_mapping_end(inp); },
        ^Res(Input inp){ return c_comment(inp); },
        ^Res(Input inp){ return c_anchor(inp); },
        ^Res(Input inp){ return c_alias(inp); },
        ^Res(Input inp){ return c_tag(inp); },
        ^Res(Input inp){ return c_literal(inp); },
        ^Res(Input inp){ return c_folded(inp); },
        ^Res(Input inp){ return c_single_quote(inp); },
        ^Res(Input inp){ return c_double_quote(inp); },
        ^Res(Input inp){ return c_directive(inp); },
        ^Res(Input inp){ return c_reserved(inp); }});
}
...
Res b_char(Input inp) {
    return peg_alt(inp, 1, (PFn[]){
        ^Res(Input inp){ return b_line_feed(inp); },
        ^Res(Input inp){ return b_carriage_return(inp); }});
}

// [27] NB-CHAR
Res nb_char(Input inp) {
    return minus(inp, ^Res(Input inp){ return c_printable(inp); }, ^Res(Input inp){ return peg_alt(inp, 1, (PFn[]){
        ^Res(Input inp){ return b_char(inp); },
        ^Res(Input inp){ return c_byte_order_mark(inp); }}); });
}

// [28] B-BREAK
Res b_break(Input inp) {
    return peg_alt(inp, 1, (PFn[]){
        ^Res(Input inp){ return peg_seq(inp, 1, (PFn[]){
            ^Res(Input inp){ return b_carriage_return(inp); },
            ^Res(Input inp){ return b_line_feed(inp); }}); },
        ^Res(Input inp){ return b_carriage_return(inp); },
        ^Res(Input inp){ return b_line_feed(inp); }});
...
Res s_white(Input inp) {
    return peg_alt(inp, 1, (PFn[]){
        ^Res(Input inp){ return s_space(inp); },
        ^Res(Input inp){ return s_tab(inp); }});
}
...
Res ns_hex_digit(Input inp) {
    return peg_alt(inp, 1, (PFn[]){
        ^Res(Input inp){ return ns_dec_digit(inp); },
        ^Res(Input inp){ return match_range(inp, 0x41, 0x46); },
        ^Res(Input inp){ return match_range(inp, 0x61, 0x66); }});
}

// [37] NS-ASCII-LETTER
Res ns_ascii_letter(Input inp) {
    return peg_alt(inp, 1, (PFn[]){
        ^Res(Input inp){ return match_range(inp, 0x41, 0x5A); },
        ^Res(Input inp){ return match_range(inp, 0x61, 0x7A); }});
}
...
Res ns_word_char(Input inp) {
    return peg_alt(inp, 1, (PFn[]){
        ^Res(Input inp){ return ns_dec_digit(inp); },
        ^Res(Input inp){ return ns_ascii_letter(inp); },
...
Res ns_uri_char(Input inp) {
    return peg_alt(inp, 1, (PFn[]){
        ^Res(Input inp){ return peg_seq(inp, 1, (PFn[]){
            ^Res(Input inp){ return match_cp(inp, 37); },
            ^Res(Input inp){ return ns_hex_digit(inp); },
            ^Res(Input inp){ return ns_hex_digit(inp); }}); },
        ^Res(Input inp){ return ns_word_char(inp); },
        ^Res(Input inp){ return match_cp(inp, 35); },
        ^Res(Input inp){ return match_cp(inp, 59); },
        ^Res(Input inp){ return match_cp(inp, 47); },
        ^Res(Input inp){ return match_cp(inp, 63); },
        ^Res(Input inp){ return match_cp(inp, 58); },
        ^Res(Input inp){ return match_cp(inp, 64); },
        ^Res(Input inp){ return match_cp(inp, 38); },
        ^Res(Input inp){ return match_cp(inp, 61); },
        ^Res(Input inp){ return match_cp(inp, 43); },
        ^Res(Input inp){ return match_cp(inp, 36); },
        ^Res(Input inp){ return match_cp(inp, 44); },
        ^Res(Input inp){ return match_cp(inp, 95); },
        ^Res(Input inp){ return match_cp(inp, 46); },
        ^Res(Input inp){ return match_cp(inp, 33); },
        ^Res(Input inp){ return match_cp(inp, 126); },
        ^Res(Input inp){ return match_cp(inp, 42); },
        ^Res(Input inp){ return match_cp(inp, 39); },
        ^Res(Input inp){ return match_cp(inp, 40); },
        ^Res(Input inp){ return match_cp(inp, 41); },
...
// [40] NS-TAG-CHAR
Res ns_tag_char(Input inp) {
    return minus(inp, ^Res(Input inp){ return ns_uri_char(inp); }, ^Res(Input inp){ return peg_alt(inp, 1, (PFn[]){
        ^Res(Input inp){ return c_tag(inp); },
        ^Res(Input inp){ return c_flow_indicator(inp); }}); });
}
...
// [59] NS-ESC-8-BIT
Res ns_esc_8_bit(Input inp) {
    return peg_seq(inp, 1, (PFn[]){
        ^Res(Input inp){ return match_cp(inp, 120); },
        ^Res(Input inp){ return rep(inp, 2, ^Res(Input inp){ return ns_hex_digit(inp); }); }});
}
...
Res ns_esc_16_bit(Input inp) {
    return peg_seq(inp, 1, (PFn[]){
        ...
        ^Res(Input inp){ return rep(inp, 4, ^Res(Input inp){ return ns_hex_digit(inp); }); }});
}

// [61] NS-ESC-32-BIT
Res ns_esc_32_bit(Input inp) {
    return peg_seq(inp, 1, (PFn[]){
        ^Res(Input inp){ return match_cp(inp, 85); },
        ^Res(Input inp){ return rep(inp, 8, ^Res(Input inp){ return ns_hex_digit(inp); }); }});
}

// [62] C-NS-ESC-CHAR
Res c_ns_esc_char(Input inp) {
    return peg_seq(inp, 1, (PFn[]){
        ^Res(Input inp){ return c_escape(inp); },
        ^Res(Input inp){ return peg_alt(inp, 1, (PFn[]){
            ^Res(Input inp){ return ns_esc_null(inp); },
            ^Res(Input inp){ return ns_esc_bell(inp); },
            ^Res(Input inp){ return ns_esc_backspace(inp); },
            ^Res(Input inp){ return ns_esc_horizontal_tab(inp); },
            ^Res(Input inp){ return ns_esc_line_feed(inp); },
            ^Res(Input inp){ return ns_esc_vertical_tab(inp); },
            ^Res(Input inp){ return ns_esc_form_feed(inp); },
            ^Res(Input inp){ return ns_esc_carriage_return(inp); },
            ^Res(Input inp){ return ns_esc_escape(inp); },
            ^Res(Input inp){ return ns_esc_space(inp); },
            ^Res(Input inp){ return ns_esc_double_quote(inp); },
            ^Res(Input inp){ return ns_esc_slash(inp); },
            ^Res(Input inp){ return ns_esc_backslash(inp); },
            ^Res(Input inp){ return ns_esc_next_line(inp); },
            ^Res(Input inp){ return ns_esc_non_breaking_space(inp); },
            ^Res(Input inp){ return ns_esc_line_separator(inp); },
            ^Res(Input inp){ return ns_esc_paragraph_separator(inp); },
            ^Res(Input inp){ return ns_esc_8_bit(inp); },
            ^Res(Input inp){ return ns_esc_16_bit(inp); },
            ^Res(Input inp){ return ns_esc_32_bit(inp); }}); }});
}
...
Res s_separate_in_line(Input inp) {
    return peg_alt(inp, 1, (PFn[]){
        ^Res(Input inp){ return plus_(inp, ^Res(Input inp){ return s_white(inp); }); },
        ^Res(Input inp){ return ok(inp); }});
}
...
Res s_flow_line_prefix(Input inp, int n) {
    return peg_seq(inp, 1, (PFn[]){
        ^Res(Input inp){ return s_indent(inp, n); },
        ^Res(Input inp){ return opt(inp, ^Res(Input inp){ return s_separate_in_line(inp); }); }});
}
...
Res l_empty(Input inp, int n, NSString *c) {
    return peg_seq(inp, 1, (PFn[]){
        ^Res(Input inp){ return peg_alt(inp, 1, (PFn[]){
            ^Res(Input inp){ return s_line_prefix(inp, n, c); },
            ^Res(Input inp){ return s_indent_lt(inp, n); }}); },
        ^Res(Input inp){ return b_as_line_feed(inp); }});
}

// [71] B-L-TRIMMED
Res b_l_trimmed(Input inp, int n, NSString *c) {
    return peg_seq(inp, 1, (PFn[]){
        ^Res(Input inp){ return b_non_content(inp); },
        ^Res(Input inp){ return plus_(inp, ^Res(Input inp){ return l_empty(inp, n, c); }); }});
}
...
Res b_l_folded(Input inp, int n, NSString *c) {
    return peg_alt(inp, 1, (PFn[]){
        ^Res(Input inp){ return b_l_trimmed(inp, n, c); },
        ^Res(Input inp){ return b_as_space(inp); }});
}
...
Res s_flow_folded(Input inp, int n) {
    return peg_seq(inp, 1, (PFn[]){
        ^Res(Input inp){ return opt(inp, ^Res(Input inp){ return s_separate_in_line(inp); }); },
        ^Res(Input inp){ return b_l_folded(inp, n, @"FLOW-IN"); },
        ^Res(Input inp){ return s_flow_line_prefix(inp, n); }});
}
...
Res c_nb_comment_text(Input inp) {
    return peg_seq(inp, 1, (PFn[]){
        ^Res(Input inp){ return c_comment(inp); },
        ^Res(Input inp){ return star(inp, ^Res(Input inp){ return nb_char(inp); }); }});
}
...
Res s_b_comment(Input inp) {
    return peg_seq(inp, 1, (PFn[]){
        ^Res(Input inp){ return opt(inp, ^Res(Input inp){ return peg_seq(inp, 1, (PFn[]){
            ^Res(Input inp){ return s_separate_in_line(inp); },
            ^Res(Input inp){ return opt(inp, ^Res(Input inp){ return c_nb_comment_text(inp); }); }}); }); },
        ^Res(Input inp){ return b_comment(inp); }});
}
...
Res s_l_comments(Input inp) {
    return peg_seq(inp, 1, (PFn[]){
        ^Res(Input inp){ return peg_alt(inp, 1, (PFn[]){
            ^Res(Input inp){ return s_b_comment(inp); },
            ^Res(Input inp){ return ok(inp); }}); },
        ^Res(Input inp){ return star(inp, ^Res(Input inp){ return l_comment(inp); }); }});
}
...
Res s_separate_lines(Input inp, int n) {
    return peg_alt(inp, 1, (PFn[]){
        ^Res(Input inp){ return peg_seq(inp, 1, (PFn[]){
            ^Res(Input inp){ return s_l_comments(inp); },
            ^Res(Input inp){ return s_flow_line_prefix(inp, n); }}); },
        ^Res(Input inp){ return s_separate_in_line(inp); }});
}
...
Res l_directive(Input inp) {
    return peg_seq(inp, 1, (PFn[]){
        ^Res(Input inp){ return c_directive(inp); },
        ^Res(Input inp){ return peg_alt(inp, 1, (PFn[]){
            ^Res(Input inp){ return ns_yaml_directive(inp); },
            ^Res(Input inp){ return ns_tag_directive(inp); },
            ^Res(Input inp){ return ns_reserved_directive(inp); }}); },
        ^Res(Input inp){ return s_l_comments(inp); }});
}
...
Res ns_reserved_directive(Input inp) {
    return peg_seq(inp, 1, (PFn[]){
        ^Res(Input inp){ return ns_directive_name(inp); },
        ^Res(Input inp){ return star(inp, ^Res(Input inp){ return peg_seq(inp, 1, (PFn[]){
            ^Res(Input inp){ return s_separate_in_line(inp); },
            ^Res(Input inp){ return ns_directive_parameter(inp); }}); }); }});
}
...
Res ns_yaml_directive(Input inp) {
    return peg_seq(inp, 1, (PFn[]){
        ^Res(Input inp){ return match_str(inp, "YAML"); },
        ^Res(Input inp){ return s_separate_in_line(inp); },
        ^Res(Input inp){ return ns_yaml_version(inp); }});
}

// [87] NS-YAML-VERSION
Res ns_yaml_version(Input inp) {
    return peg_seq(inp, 1, (PFn[]){
        ^Res(Input inp){ return plus_(inp, ^Res(Input inp){ return ns_dec_digit(inp); }); },
        ^Res(Input inp){ return match_cp(inp, 46); },
        ^Res(Input inp){ return plus_(inp, ^Res(Input inp){ return ns_dec_digit(inp); }); }});
}
...
Res ns_tag_directive(Input inp) {
    return peg_seq(inp, 1, (PFn[]){
        ^Res(Input inp){ return match_str(inp, "TAG"); },
        ^Res(Input inp){ return s_separate_in_line(inp); },
        ^Res(Input inp){ return c_tag_handle(inp); },
        ^Res(Input inp){ return s_separate_in_line(inp); },
        ^Res(Input inp){ return ns_tag_prefix(inp); }});
}

// [89] C-TAG-HANDLE
Res c_tag_handle(Input inp) {
    return peg_alt(inp, 1, (PFn[]){
        ^Res(Input inp){ return c_named_tag_handle(inp); },
        ^Res(Input inp){ return c_secondary_tag_handle(inp); },
        ^Res(Input inp){ return c_primary_tag_handle(inp); }});
}
...
Res c_named_tag_handle(Input inp) {
    return peg_seq(inp, 1, (PFn[]){
        ^Res(Input inp){ return match_cp(inp, 33); },
        ^Res(Input inp){ return plus_(inp, ^Res(Input inp){ return ns_word_char(inp); }); },
        ^Res(Input inp){ return match_cp(inp, 33); }});
}
...
Res ns_tag_prefix(Input inp) {
    return peg_alt(inp, 1, (PFn[]){
        ^Res(Input inp){ return c_ns_local_tag_prefix(inp); },
        ^Res(Input inp){ return ns_global_tag_prefix(inp); }});
}
...
Res c_ns_local_tag_prefix(Input inp) {
    return peg_seq(inp, 1, (PFn[]){
        ^Res(Input inp){ return match_cp(inp, 33); },
        ^Res(Input inp){ return star(inp, ^Res(Input inp){ return ns_uri_char(inp); }); }});
}

// [95] NS-GLOBAL-TAG-PREFIX
Res ns_global_tag_prefix(Input inp) {
    return peg_seq(inp, 1, (PFn[]){
        ^Res(Input inp){ return ns_tag_char(inp); },
        ^Res(Input inp){ return star(inp, ^Res(Input inp){ return ns_uri_char(inp); }); }});
}
...
Res c_ns_properties(Input inp, int n, NSString *c) {
    return peg_alt(inp, 1, (PFn[]){
        ^Res(Input inp){ return peg_seq(inp, 1, (PFn[]){
            ^Res(Input inp){ return c_ns_tag_property(inp); },
            ^Res(Input inp){ return opt(inp, ^Res(Input inp){ return peg_seq(inp, 1, (PFn[]){
                ^Res(Input inp){ return s_separate(inp, n, c); },
                ^Res(Input inp){ return c_ns_anchor_property(inp); }}); }); }}); },
        ^Res(Input inp){ return peg_seq(inp, 1, (PFn[]){
            ^Res(Input inp){ return c_ns_anchor_property(inp); },
            ^Res(Input inp){ return opt(inp, ^Res(Input inp){ return peg_seq(inp, 1, (PFn[]){
                ^Res(Input inp){ return s_separate(inp, n, c); },
...
Res c_ns_tag_property(Input inp) {
    return peg_alt(inp, 1, (PFn[]){
        ^Res(Input inp){ return c_verbatim_tag(inp); },
        ^Res(Input inp){ return c_ns_shorthand_tag(inp); },
        ^Res(Input inp){ return c_non_specific_tag(inp); }});
}

// [98] C-VERBATIM-TAG
Res c_verbatim_tag(Input inp) {
    return peg_seq(inp, 1, (PFn[]){
        ^Res(Input inp){ return match_str(inp, "!<"); },
        ^Res(Input inp){ return plus_(inp, ^Res(Input inp){ return ns_uri_char(inp); }); },
        ^Res(Input inp){ return match_cp(inp, 62); }});
}
...
Res c_ns_shorthand_tag(Input inp) {
    return peg_seq(inp, 1, (PFn[]){
        ^Res(Input inp){ return c_tag_handle(inp); },
        ^Res(Input inp){ return plus_(inp, ^Res(Input inp){ return ns_tag_char(inp); }); }});
}
...
Res c_ns_anchor_property(Input inp) {
    return build(inp, "ANCHOR", ^Res(Input inp){ return peg_seq(inp, 1, (PFn[]){
        ^Res(Input inp){ return c_anchor(inp); },
        ^Res(Input inp){ return scalar(inp, ^Res(Input inp){ return ns_anchor_name(inp); }); }}); });
}
...
// [104] C-NS-ALIAS-NODE
Res c_ns_alias_node(Input inp) {
    return build(inp, "ALIAS", ^Res(Input inp){ return peg_seq(inp, 1, (PFn[]){
        ^Res(Input inp){ return c_alias(inp); },
        ^Res(Input inp){ return scalar(inp, ^Res(Input inp){ return ns_anchor_name(inp); }); }}); });
}
...
Res nb_double_char(Input inp) {
    return peg_alt(inp, 1, (PFn[]){
        ^Res(Input inp){ return c_ns_esc_char(inp); },
        ^Res(Input inp){ return minus(inp, ^Res(Input inp){ return nb_json(inp); }, ^Res(Input inp){ return peg_alt(inp, 1, (PFn[]){
...
// [109] C-DOUBLE-QUOTED
Res c_double_quoted(Input inp, int n, NSString *c) {
    return scalar(inp, ^Res(Input inp){ return peg_seq(inp, 1, (PFn[]){
        ^Res(Input inp){ return match_cp(inp, 34); },
        ^Res(Input inp){ return nb_double_text(inp, n, c); },
        ^Res(Input inp){ return match_cp(inp, 34); }}); });
}
...
Res s_double_escaped(Input inp, int n) {
    return peg_seq(inp, 1, (PFn[]){
        ^Res(Input inp){ return star(inp, ^Res(Input inp){ return s_white(inp); }); },
        ^Res(Input inp){ return match_cp(inp, 92); },
        ^Res(Input inp){ return b_non_content(inp); },
        ^Res(Input inp){ return star(inp, ^Res(Input inp){ return l_empty(inp, n, @"FLOW-IN"); }); },
        ^Res(Input inp){ return s_flow_line_prefix(inp, n); }});
}
...
Res s_double_break(Input inp, int n) {
    return peg_alt(inp, 1, (PFn[]){
        ^Res(Input inp){ return s_double_escaped(inp, n); },
        ^Res(Input inp){ return s_flow_folded(inp, n); }});
}

// [114] NB-NS-DOUBLE-IN-LINE
Res nb_ns_double_in_line(Input inp) {
    return star(inp, ^Res(Input inp){ return peg_seq(inp, 1, (PFn[]){
        ^Res(Input inp){ return star(inp, ^Res(Input inp){ return s_white(inp); }); },
        ^Res(Input inp){ return ns_double_char(inp); }}); });
}

// [115] S-DOUBLE-NEXT-LINE
Res s_double_next_line(Input inp, int n) {
    return peg_seq(inp, 1, (PFn[]){
        ^Res(Input inp){ return s_double_break(inp, n); },
        ^Res(Input inp){ return opt(inp, ^Res(Input inp){ return peg_seq(inp, 1, (PFn[]){
            ^Res(Input inp){ return ns_double_char(inp); },
            ^Res(Input inp){ return nb_ns_double_in_line(inp); },
            ^Res(Input inp){ return peg_alt(inp, 1, (PFn[]){
                ^Res(Input inp){ return s_double_next_line(inp, n); },
                ^Res(Input inp){ return star(inp, ^Res(Input inp){ return s_white(inp); }); }}); }}); }); }});
}
...
Res nb_single_char(Input inp) {
    return peg_alt(inp, 1, (PFn[]){
        ^Res(Input inp){ return c_quoted_quote(inp); },
        ^Res(Input inp){ return minus(inp, ^Res(Input inp){ return nb_json(inp); }, ^Res(Input inp){ return match_cp(inp, 39); }); }});
}
...
Res c_single_quoted(Input inp, int n, NSString *c) {
    return scalar(inp, ^Res(Input inp){ return peg_seq(inp, 1, (PFn[]){
        ^Res(Input inp){ return match_cp(inp, 39); },
        ^Res(Input inp){ return nb_single_text(inp, n, c); },
        ^Res(Input inp){ return match_cp(inp, 39); }}); });
}
...
Res ns_single_in_line(Input inp) {
    return star(inp, ^Res(Input inp){ return peg_seq(inp, 1, (PFn[]){
        ^Res(Input inp){ return star(inp, ^Res(Input inp){ return s_white(inp); }); },
        ^Res(Input inp){ return ns_single_char(inp); }}); });
}
...
Res s_single_next_line(Input inp, int n) {
    return peg_seq(inp, 1, (PFn[]){
        ...
        ^Res(Input inp){ return opt(inp, ^Res(Input inp){ return peg_seq(inp, 1, (PFn[]){
            ^Res(Input inp){ return ns_single_char(inp); },
            ^Res(Input inp){ return ns_single_in_line(inp); },
            ^Res(Input inp){ return peg_alt(inp, 1, (PFn[]){
                ^Res(Input inp){ return s_single_next_line(inp, n); },
                ^Res(Input inp){ return star(inp, ^Res(Input inp){ return s_white(inp); }); }}); }}); }); }});
}
...
Res ns_plain_first(Input inp, NSString *c) {
    return peg_alt(inp, 1, (PFn[]){
        ^Res(Input inp){ return minus(inp, ^Res(Input inp){ return ns_char(inp); }, ^Res(Input inp){ return c_indicator(inp); }); },
        ^Res(Input inp){ return peg_seq(inp, 1, (PFn[]){
            ^Res(Input inp){ return peg_alt(inp, 1, (PFn[]){
                ^Res(Input inp){ return match_cp(inp, 63); },
                ^Res(Input inp){ return match_cp(inp, 58); },
                ^Res(Input inp){ return match_cp(inp, 45); }}); },
            ^Res(Input inp){ return ahead(inp, ^Res(Input inp){ return ns_plain_safe(inp, c); }); }}); }});
}
...
Res ns_plain_char(Input inp, NSString *c) {
    return peg_alt(inp, 1, (PFn[]){
        ^Res(Input inp){ return minus(inp, ^Res(Input inp){ return ns_plain_safe(inp, c); }, ^Res(Input inp){ return peg_alt(inp, 1, (PFn[]){
            ^Res(Input inp){ return match_cp(inp, 58); },
            ^Res(Input inp){ return match_cp(inp, 35); }}); }); },
        ^Res(Input inp){ return peg_seq(inp, 1, (PFn[]){
            ^Res(Input inp){ return behind(inp, ^Res(Input inp){ return ns_char(inp); }); },
            ^Res(Input inp){ return match_cp(inp, 35); }}); },
        ^Res(Input inp){ return peg_seq(inp, 1, (PFn[]){
            ^Res(Input inp){ return match_cp(inp, 58); },
            ^Res(Input inp){ return ahead(inp, ^Res(Input inp){ return ns_plain_safe(inp, c); }); }}); }});
...
Res nb_ns_plain_in_line(Input inp, NSString *c) {
    return star(inp, ^Res(Input inp){ return peg_seq(inp, 1, (PFn[]){
        ^Res(Input inp){ return star(inp, ^Res(Input inp){ return s_white(inp); }); },
        ^Res(Input inp){ return ns_plain_char(inp, c); }}); });
}

// [133] NS-PLAIN-ONE-LINE
Res ns_plain_one_line(Input inp, NSString *c) {
    return peg_seq(inp, 1, (PFn[]){
        ^Res(Input inp){ return ns_plain_first(inp, c); },
        ^Res(Input inp){ return nb_ns_plain_in_line(inp, c); }});
}
...
Res s_ns_plain_next_line(Input inp, int n, NSString *c) {
    return peg_seq(inp, 1, (PFn[]){
        ^Res(Input inp){ return s_flow_folded(inp, n); },
        ^Res(Input inp){ return neg(inp, ^Res(Input inp){ return c_forbidden(inp); }); },
        ^Res(Input inp){ return ns_plain_char(inp, c); },
        ^Res(Input inp){ return nb_ns_plain_in_line(inp, c); }});
}
...
Res ns_plain_multi_line(Input inp, int n, NSString *c) {
    return peg_seq(inp, 1, (PFn[]){
        ^Res(Input inp){ return ns_plain_one_line(inp, c); },
        ^Res(Input inp){ return star(inp, ^Res(Input inp){ return s_ns_plain_next_line(inp, n, c); }); }});
}

// [137] C-FLOW-SEQUENCE
Res c_flow_sequence(Input inp, int n, NSString *c) {
    return build(inp, "SEQUENCE", ^Res(Input inp){ return peg_seq(inp, 1, (PFn[]){
        ^Res(Input inp){ return match_cp(inp, 91); },
        ^Res(Input inp){ return opt(inp, ^Res(Input inp){ return s_separate(inp, n, c); }); },
        ^Res(Input inp){ return opt(inp, ^Res(Input inp){ return collect(inp, ^Res(Input inp){ return ns_s_flow_seq_entries(inp, n, in_flow(c)); }); }); },
        ^Res(Input inp){ return match_cp(inp, 93); }}); });
}
...
Res ns_s_flow_seq_entries(Input inp, int n, NSString *c) {
    return peg_seq(inp, 1, (PFn[]){
        ^Res(Input inp){ return ns_flow_seq_entry(inp, n, c); },
        ^Res(Input inp){ return opt(inp, ^Res(Input inp){ return s_separate(inp, n, c); }); },
        ^Res(Input inp){ return opt(inp, ^Res(Input inp){ return peg_seq(inp, 1, (PFn[]){
            ^Res(Input inp){ return match_cp(inp, 44); },
            ^Res(Input inp){ return opt(inp, ^Res(Input inp){ return s_separate(inp, n, c); }); },
            ^Res(Input inp){ return opt(inp, ^Res(Input inp){ return ns_s_flow_seq_entries(inp, n, c); }); }}); }); }});
}

// [139] NS-FLOW-SEQ-ENTRY
Res ns_flow_seq_entry(Input inp, int n, NSString *c) {
    return peg_alt(inp, 1, (PFn[]){
        ^Res(Input inp){ return ns_flow_pair(inp, n, c); },
        ^Res(Input inp){ return ns_flow_node(inp, n, c); }});
}

// [140] C-FLOW-MAPPING
Res c_flow_mapping(Input inp, int n, NSString *c) {
    return build(inp, "MAPPING", ^Res(Input inp){ return peg_seq(inp, 1, (PFn[]){
        ^Res(Input inp){ return match_cp(inp, 123); },
        ^Res(Input inp){ return opt(inp, ^Res(Input inp){ return s_separate(inp, n, c); }); },
        ^Res(Input inp){ return opt(inp, ^Res(Input inp){ return collect(inp, ^Res(Input inp){ return ns_s_flow_map_entries(inp, n, in_flow(c)); }); }); },
...
Res ns_s_flow_map_entries(Input inp, int n, NSString *c) {
    return peg_seq(inp, 1, (PFn[]){
        ^Res(Input inp){ return ns_flow_map_entry(inp, n, c); },
        ^Res(Input inp){ return opt(inp, ^Res(Input inp){ return s_separate(inp, n, c); }); },
        ^Res(Input inp){ return opt(inp, ^Res(Input inp){ return peg_seq(inp, 1, (PFn[]){
            ^Res(Input inp){ return match_cp(inp, 44); },
            ^Res(Input inp){ return opt(inp, ^Res(Input inp){ return s_separate(inp, n, c); }); },
            ^Res(Input inp){ return opt(inp, ^Res(Input inp){ return ns_s_flow_map_entries(inp, n, c); }); }}); }); }});
}
...
Res ns_flow_map_entry(Input inp, int n, NSString *c) {
    return peg_alt(inp, 1, (PFn[]){
        ^Res(Input inp){ return peg_seq(inp, 1, (PFn[]){
            ^Res(Input inp){ return match_cp(inp, 63); },
            ^Res(Input inp){ return s_separate(inp, n, c); },
            ^Res(Input inp){ return ns_flow_map_explicit_entry(inp, n, c); }}); },
        ^Res(Input inp){ return ns_flow_map_implicit_entry(inp, n, c); }});
}
...
Res ns_flow_map_explicit_entry(Input inp, int n, NSString *c) {
    return peg_alt(inp, 1, (PFn[]){
        ^Res(Input inp){ return ns_flow_map_implicit_entry(inp, n, c); },
        ^Res(Input inp){ return peg_seq(inp, 1, (PFn[]){
            ^Res(Input inp){ return e_node(inp); },
            ^Res(Input inp){ return e_node(inp); }}); }});
}

// [144] NS-FLOW-MAP-IMPLICIT-ENTRY
Res ns_flow_map_implicit_entry(Input inp, int n, NSString *c) {
    return build(inp, "PAIR", ^Res(Input inp){ return peg_alt(inp, 1, (PFn[]){
        ^Res(Input inp){ return ns_flow_map_yaml_key_entry(inp, n, c); },
        ^Res(Input inp){ return c_ns_flow_map_empty_key_entry(inp, n, c); },
        ^Res(Input inp){ return c_ns_flow_map_json_key_entry(inp, n, c); }}); });
}

// [145] NS-FLOW-MAP-YAML-KEY-ENTRY
Res ns_flow_map_yaml_key_entry(Input inp, int n, NSString *c) {
    return peg_seq(inp, 1, (PFn[]){
        ^Res(Input inp){ return ns_flow_yaml_node(inp, n, c); },
        ^Res(Input inp){ return peg_alt(inp, 1, (PFn[]){
            ^Res(Input inp){ return peg_seq(inp, 1, (PFn[]){
                ^Res(Input inp){ return opt(inp, ^Res(Input inp){ return s_separate(inp, n, c); }); },
                ^Res(Input inp){ return c_ns_flow_map_separate_value(inp, n, c); }}); },
            ^Res(Input inp){ return e_node(inp); }}); }});
}
...
Res c_ns_flow_map_separate_value(Input inp, int n, NSString *c) {
    return peg_seq(inp, 1, (PFn[]){
        ^Res(Input inp){ return match_cp(inp, 58); },
        ^Res(Input inp){ return neg(inp, ^Res(Input inp){ return ns_plain_safe(inp, c); }); },
        ^Res(Input inp){ return peg_alt(inp, 1, (PFn[]){
            ^Res(Input inp){ return peg_seq(inp, 1, (PFn[]){
                ^Res(Input inp){ return s_separate(inp, n, c); },
                ^Res(Input inp){ return ns_flow_node(inp, n, c); }}); },
...
Res c_ns_flow_map_json_key_entry(Input inp, int n, NSString *c) {
    return peg_seq(inp, 1, (PFn[]){
        ^Res(Input inp){ return c_flow_json_node(inp, n, c); },
        ^Res(Input inp){ return peg_alt(inp, 1, (PFn[]){
            ^Res(Input inp){ return peg_seq(inp, 1, (PFn[]){
                ^Res(Input inp){ return opt(inp, ^Res(Input inp){ return s_separate(inp, n, c); }); },
                ^Res(Input inp){ return c_ns_flow_map_adjacent_value(inp, n, c); }}); },
            ^Res(Input inp){ return e_node(inp); }}); }});
}
...
Res ns_flow_pair(Input inp, int n, NSString *c) {
    return peg_alt(inp, 1, (PFn[]){
        ^Res(Input inp){ return peg_seq(inp, 1, (PFn[]){
            ...
            ^Res(Input inp){ return s_separate(inp, n, c); },
            ^Res(Input inp){ return ns_flow_map_explicit_entry(inp, n, c); }}); },
        ^Res(Input inp){ return ns_flow_pair_entry(inp, n, c); }});
}

// [151] NS-FLOW-PAIR-ENTRY
Res ns_flow_pair_entry(Input inp, int n, NSString *c) {
    return peg_alt(inp, 1, (PFn[]){
        ^Res(Input inp){ return ns_flow_pair_yaml_key_entry(inp, n, c); },
        ^Res(Input inp){ return c_ns_flow_map_empty_key_entry(inp, n, c); },
        ^Res(Input inp){ return c_ns_flow_pair_json_key_entry(inp, n, c); }});
}

// [152] NS-FLOW-PAIR-YAML-KEY-ENTRY
Res ns_flow_pair_yaml_key_entry(Input inp, int n, NSString *c) {
    return peg_seq(inp, 1, (PFn[]){
        ^Res(Input inp){ return ns_s_implicit_yaml_key(inp, @"FLOW-KEY"); },
        ^Res(Input inp){ return c_ns_flow_map_separate_value(inp, n, c); }});
}
...
Res c_ns_flow_pair_json_key_entry(Input inp, int n, NSString *c) {
    return peg_seq(inp, 1, (PFn[]){
        ^Res(Input inp){ return c_s_implicit_json_key(inp, @"FLOW-KEY"); },
        ^Res(Input inp){ return c_ns_flow_map_adjacent_value(inp, n, c); }});
}
...
Res ns_s_implicit_yaml_key(Input inp, NSString *c) {
    return peg_seq(inp, 1, (PFn[]){
        ^Res(Input inp){ return ns_flow_yaml_node(inp, 0, c); },
        ^Res(Input inp){ return opt(inp, ^Res(Input inp){ return s_separate_in_line(inp); }); }});
}
...
Res c_s_implicit_json_key(Input inp, NSString *c) {
    return peg_seq(inp, 1, (PFn[]){
        ^Res(Input inp){ return c_flow_json_node(inp, 0, c); },
        ^Res(Input inp){ return opt(inp, ^Res(Input inp){ return s_separate_in_line(inp); }); }});
}
...
Res c_flow_json_content(Input inp, int n, NSString *c) {
    return peg_alt(inp, 1, (PFn[]){
        ^Res(Input inp){ return c_flow_sequence(inp, n, c); },
        ^Res(Input inp){ return c_flow_mapping(inp, n, c); },
        ^Res(Input inp){ return c_single_quoted(inp, n, c); },
        ^Res(Input inp){ return c_double_quoted(inp, n, c); }});
}

// [158] NS-FLOW-CONTENT
Res ns_flow_content(Input inp, int n, NSString *c) {
    return peg_alt(inp, 1, (PFn[]){
        ^Res(Input inp){ return ns_flow_yaml_content(inp, n, c); },
        ^Res(Input inp){ return c_flow_json_content(inp, n, c); }});
}

// [159] NS-FLOW-YAML-NODE
Res ns_flow_yaml_node(Input inp, int n, NSString *c) {
    return peg_alt(inp, 1, (PFn[]){
        ^Res(Input inp){ return c_ns_alias_node(inp); },
        ^Res(Input inp){ return ns_flow_yaml_content(inp, n, c); },
        ^Res(Input inp){ return peg_seq(inp, 1, (PFn[]){
            ^Res(Input inp){ return c_ns_properties(inp, n, c); },
            ^Res(Input inp){ return peg_alt(inp, 1, (PFn[]){
                ^Res(Input inp){ return peg_seq(inp, 1, (PFn[]){
                    ^Res(Input inp){ return s_separate(inp, n, c); },
                    ^Res(Input inp){ return ns_flow_yaml_content(inp, n, c); }}); },
                ^Res(Input inp){ return e_scalar(inp); }}); }}); }});
}
...
Res ns_flow_node(Input inp, int n, NSString *c) {
    return peg_alt(inp, 1, (PFn[]){
        ^Res(Input inp){ return c_ns_alias_node(inp); },
        ^Res(Input inp){ return ns_flow_content(inp, n, c); },
        ^Res(Input inp){ return peg_seq(inp, 1, (PFn[]){
            ^Res(Input inp){ return c_ns_properties(inp, n, c); },
            ^Res(Input inp){ return peg_alt(inp, 1, (PFn[]){
                ^Res(Input inp){ return peg_seq(inp, 1, (PFn[]){
...
Res c_b_block_header(Input inp, int n) {
    return peg_alt(inp, 1, (PFn[]){
        ^Res(Input inp){ return (^Res{ Res r=peg_alt(inp, 1, (PFn[]){
            ^Res(Input inp){ return parse_int(inp, ^Res(Input inp){ return ns_dec_digit(inp); }); },
            ^Res(Input inp){ return detect_indent(inp, n); }}); if(r->failed) return r; int m=r->tagInt; return (^Res(Input inp){ return (^Res{ Res r=peg_alt(inp, 1, (PFn[]){
            ^Res(Input inp){ return parse_sym(inp, ^Res(Input inp){ return match_cp(inp, 45); }, "STRIP"); },
            ^Res(Input inp){ return parse_sym(inp, ^Res(Input inp){ return match_cp(inp, 43); }, "KEEP"); },
            ^Res(Input inp){ return val(inp, "CLIP"); }}); if(r->failed) return r; NSString *t=r->tag; return (^Res(Input inp){ return s_b_comment(inp); })(r->rest); })(); })(r->rest); })(); },
        ^Res(Input inp){ return (^Res{ Res r=peg_alt(inp, 1, (PFn[]){
            ^Res(Input inp){ return parse_sym(inp, ^Res(Input inp){ return match_cp(inp, 45); }, "STRIP"); },
            ^Res(Input inp){ return parse_sym(inp, ^Res(Input inp){ return match_cp(inp, 43); }, "KEEP"); },
            ^Res(Input inp){ return val(inp, "CLIP"); }}); if(r->failed) return r; NSString *t=r->tag; return (^Res(Input inp){ return (^Res{ Res r=peg_alt(inp, 1, (PFn[]){
            ^Res(Input inp){ return parse_int(inp, ^Res(Input inp){ return ns_dec_digit(inp); }); },
            ^Res(Input inp){ return detect_indent(inp, n); }}); if(r->failed) return r; int m=r->tagInt; return (^Res(Input inp){ return s_b_comment(inp); })(r->rest); })(); })(r->rest); })(); }});
}
...
Res l_strip_empty(Input inp, int n) {
    return peg_seq(inp, 1, (PFn[]){
        ^Res(Input inp){ return star(inp, ^Res(Input inp){ return peg_seq(inp, 1, (PFn[]){
            ^Res(Input inp){ return s_indent_le(inp, n); },
            ^Res(Input inp){ return b_non_content(inp); }}); }); },
        ^Res(Input inp){ return opt(inp, ^Res(Input inp){ return l_trail_comments(inp, n); }); }});
}

// [168] L-KEEP-EMPTY
Res l_keep_empty(Input inp, int n) {
    return peg_seq(inp, 1, (PFn[]){
        ^Res(Input inp){ return star(inp, ^Res(Input inp){ return l_empty(inp, n, @"BLOCK-IN"); }); },
        ^Res(Input inp){ return opt(inp, ^Res(Input inp){ return l_trail_comments(inp, n); }); }});
}
...
Res l_trail_comments(Input inp, int n) {
    return peg_seq(inp, 1, (PFn[]){
        ^Res(Input inp){ return s_indent_lt(inp, n); },
        ^Res(Input inp){ return c_nb_comment_text(inp); },
        ^Res(Input inp){ return b_comment(inp); },
        ^Res(Input inp){ return star(inp, ^Res(Input inp){ return l_comment(inp); }); }});
}
...
Res c_lliteral(Input inp, int n) {
    return peg_seq(inp, 1, (PFn[]){
        ^Res(Input inp){ return match_cp(inp, 124); },
        ^Res(Input inp){ return (^Res{ Res r=peg_alt(inp, 1, (PFn[]){
            ^Res(Input inp){ return parse_int(inp, ^Res(Input inp){ return ns_dec_digit(inp); }); },
            ^Res(Input inp){ return detect_indent(inp, n); }}); if(r->failed) return r; int m=r->tagInt; return (^Res(Input inp){ return (^Res{ Res r=peg_alt(inp, 1, (PFn[]){
            ^Res(Input inp){ return parse_sym(inp, ^Res(Input inp){ return match_cp(inp, 45); }, "STRIP"); },
            ^Res(Input inp){ return parse_sym(inp, ^Res(Input inp){ return match_cp(inp, 43); }, "KEEP"); },
            ^Res(Input inp){ return val(inp, "CLIP"); }}); if(r->failed) return r; NSString *t=r->tag; return (^Res(Input inp){ return peg_seq(inp, 1, (PFn[]){
            ^Res(Input inp){ return s_b_comment(inp); },
            ^Res(Input inp){ return l_literal_content(inp, (n + m), t); }}); })(r->rest); })(); })(r->rest); })(); }});
}
...
Res l_nb_literal_text(Input inp, int n) {
    return peg_seq(inp, 1, (PFn[]){
        ^Res(Input inp){ return star(inp, ^Res(Input inp){ return l_empty(inp, n, @"BLOCK-IN"); }); },
        ^Res(Input inp){ return s_indent(inp, n); },
        ^Res(Input inp){ return plus_(inp, ^Res(Input inp){ return nb_char(inp); }); }});
}
...
Res b_nb_literal_next(Input inp, int n) {
    return peg_seq(inp, 1, (PFn[]){
        ^Res(Input inp){ return b_as_line_feed(inp); },
        ^Res(Input inp){ return l_nb_literal_text(inp, n); }});
}
...
Res l_literal_content(Input inp, int n, NSString *t) {
    return scalar(inp, ^Res(Input inp){ return peg_seq(inp, 1, (PFn[]){
        ^Res(Input inp){ return opt(inp, ^Res(Input inp){ return peg_seq(inp, 1, (PFn[]){
            ^Res(Input inp){ return l_nb_literal_text(inp, n); },
            ^Res(Input inp){ return star(inp, ^Res(Input inp){ return b_nb_literal_next(inp, n); }); },
            ^Res(Input inp){ return b_chomped_last(inp, t); }}); }); },
        ^Res(Input inp){ return l_chomped_empty(inp, n, t); }}); });
}
...
Res c_lfolded(Input inp, int n) {
    return peg_seq(inp, 1, (PFn[]){
        ...
        ^Res(Input inp){ return (^Res{ Res r=peg_alt(inp, 1, (PFn[]){
            ...
            ^Res(Input inp){ return val(inp, "CLIP"); }}); if(r->failed) return r; NSString *t=r->tag; return (^Res(Input inp){ return peg_seq(inp, 1, (PFn[]){
            ^Res(Input inp){ return s_b_comment(inp); },
            ^Res(Input inp){ return l_folded_content(inp, (n + m), t); }}); })(r->rest); })(); })(r->rest); })(); }});
}
...
Res s_nb_folded_text(Input inp, int n) {
    return peg_seq(inp, 1, (PFn[]){
        ^Res(Input inp){ return s_indent(inp, n); },
        ^Res(Input inp){ return ns_char(inp); },
        ^Res(Input inp){ return star(inp, ^Res(Input inp){ return nb_char(inp); }); }});
}
...
Res l_nb_folded_lines(Input inp, int n) {
    return peg_seq(inp, 1, (PFn[]){
        ^Res(Input inp){ return s_nb_folded_text(inp, n); },
        ^Res(Input inp){ return star(inp, ^Res(Input inp){ return peg_seq(inp, 1, (PFn[]){
            ^Res(Input inp){ return b_l_folded(inp, n, @"BLOCK-IN"); },
            ^Res(Input inp){ return s_nb_folded_text(inp, n); }}); }); }});
}
...
Res s_nb_spaced_text(Input inp, int n) {
    return peg_seq(inp, 1, (PFn[]){
        ^Res(Input inp){ return s_indent(inp, n); },
        ^Res(Input inp){ return s_white(inp); },
        ^Res(Input inp){ return star(inp, ^Res(Input inp){ return nb_char(inp); }); }});
}
...
Res l_nb_spaced_lines(Input inp, int n) {
    return peg_seq(inp, 1, (PFn[]){
        ^Res(Input inp){ return s_nb_spaced_text(inp, n); },
        ^Res(Input inp){ return star(inp, ^Res(Input inp){ return peg_seq(inp, 1, (PFn[]){
            ^Res(Input inp){ return b_l_spaced(inp, n); },
            ^Res(Input inp){ return s_nb_spaced_text(inp, n); }}); }); }});
}
...
Res l_nb_same_lines(Input inp, int n) {
    return peg_seq(inp, 1, (PFn[]){
        ^Res(Input inp){ return star(inp, ^Res(Input inp){ return l_empty(inp, n, @"BLOCK-IN"); }); },
        ^Res(Input inp){ return peg_alt(inp, 1, (PFn[]){
            ^Res(Input inp){ return l_nb_folded_lines(inp, n); },
            ^Res(Input inp){ return l_nb_spaced_lines(inp, n); }}); }});
}

// [181] L-NB-DIFF-LINES
Res l_nb_diff_lines(Input inp, int n) {
    return peg_seq(inp, 1, (PFn[]){
        ^Res(Input inp){ return l_nb_same_lines(inp, n); },
        ^Res(Input inp){ return star(inp, ^Res(Input inp){ return peg_seq(inp, 1, (PFn[]){
            ^Res(Input inp){ return b_as_line_feed(inp); },
            ^Res(Input inp){ return l_nb_same_lines(inp, n); }}); }); }});
}
...
Res l_folded_content(Input inp, int n, NSString *t) {
    return scalar(inp, ^Res(Input inp){ return peg_seq(inp, 1, (PFn[]){
        ^Res(Input inp){ return opt(inp, ^Res(Input inp){ return peg_seq(inp, 1, (PFn[]){
            ^Res(Input inp){ return l_nb_diff_lines(inp, n); },
            ^Res(Input inp){ return b_chomped_last(inp, t); }}); }); },
        ^Res(Input inp){ return l_chomped_empty(inp, n, t); }}); });
}
...
Res lblock_sequence(Input inp, int n) {
    return build(inp, "SEQUENCE", ^Res(Input inp){ return (^Res{ Res r=detect_indent(inp, n); if(r->failed) return r; int m=r->tagInt; return (^Res(Input inp){ return collect(inp, ^Res(Input inp){ return plus_(inp, ^Res(Input inp){ return peg_seq(inp, 1, (PFn[]){
        ^Res(Input inp){ return s_indent(inp, (n + m)); },
        ^Res(Input inp){ return c_l_block_seq_entry(inp, (n + m)); }}); }); }); })(r->rest); })(); });
}
...
Res c_l_block_seq_entry(Input inp, int n) {
    return peg_seq(inp, 1, (PFn[]){
        ^Res(Input inp){ return match_cp(inp, 45); },
        ^Res(Input inp){ return neg(inp, ^Res(Input inp){ return ns_char(inp); }); },
        ^Res(Input inp){ return s_lblock_indented(inp, n, @"BLOCK-IN"); }});
}

// [185] S-L+BLOCK-INDENTED
Res s_lblock_indented(Input inp, int n, NSString *c) {
    return peg_alt(inp, 1, (PFn[]){
        ^Res(Input inp){ return (^Res{ Res r=detect_indent(inp, 0); if(r->failed) return r; int m=r->tagInt; return (^Res(Input inp){ return peg_seq(inp, 1, (PFn[]){
            ^Res(Input inp){ return s_indent(inp, m); },
            ^Res(Input inp){ return peg_alt(inp, 1, (PFn[]){
                ^Res(Input inp){ return ns_l_compact_sequence(inp, (n + 1 + m)); },
                ^Res(Input inp){ return ns_l_compact_mapping(inp, (n + 1 + m)); }}); }}); })(r->rest); })(); },
        ^Res(Input inp){ return s_lblock_node(inp, n, c); },
        ^Res(Input inp){ return peg_seq(inp, 1, (PFn[]){
            ^Res(Input inp){ return e_node(inp); },
            ^Res(Input inp){ return s_l_comments(inp); }}); }});
}
...
Res ns_l_compact_sequence(Input inp, int n) {
    return peg_seq(inp, 1, (PFn[]){
        ^Res(Input inp){ return c_l_block_seq_entry(inp, n); },
        ^Res(Input inp){ return star(inp, ^Res(Input inp){ return peg_seq(inp, 1, (PFn[]){
            ^Res(Input inp){ return s_indent(inp, n); },
            ^Res(Input inp){ return c_l_block_seq_entry(inp, n); }}); }); }});
}
...
// [187] L+BLOCK-MAPPING
Res lblock_mapping(Input inp, int n) {
    return build(inp, "MAPPING", ^Res(Input inp){ return (^Res{ Res r=detect_indent(inp, n); if(r->failed) return r; int m=r->tagInt; return (^Res(Input inp){ return collect(inp, ^Res(Input inp){ return plus_(inp, ^Res(Input inp){ return peg_seq(inp, 1, (PFn[]){
        ^Res(Input inp){ return s_indent(inp, (n + m)); },
        ^Res(Input inp){ return ns_l_block_map_entry(inp, (n + m)); }}); }); }); })(r->rest); })(); });
}

// [188] NS-L-BLOCK-MAP-ENTRY
Res ns_l_block_map_entry(Input inp, int n) {
    return peg_alt(inp, 1, (PFn[]){
        ^Res(Input inp){ return c_l_block_map_explicit_entry(inp, n); },
        ^Res(Input inp){ return ns_l_block_map_implicit_entry(inp, n); }});
}

// [189] C-L-BLOCK-MAP-EXPLICIT-ENTRY
Res c_l_block_map_explicit_entry(Input inp, int n) {
    return peg_seq(inp, 1, (PFn[]){
        ^Res(Input inp){ return c_l_block_map_explicit_key(inp, n); },
        ^Res(Input inp){ return peg_alt(inp, 1, (PFn[]){
            ^Res(Input inp){ return l_block_map_explicit_value(inp, n); },
            ^Res(Input inp){ return e_node(inp); }}); }});
}
...
Res c_l_block_map_explicit_key(Input inp, int n) {
    return peg_seq(inp, 1, (PFn[]){
        ^Res(Input inp){ return match_cp(inp, 63); },
        ^Res(Input inp){ return s_lblock_indented(inp, n, @"BLOCK-OUT"); }});
}
...
Res ns_l_block_map_implicit_entry(Input inp, int n) {
    return build(inp, "PAIR", ^Res(Input inp){ return peg_seq(inp, 1, (PFn[]){
        ^Res(Input inp){ return scalar(inp, ^Res(Input inp){ return peg_alt(inp, 1, (PFn[]){
            ^Res(Input inp){ return ns_s_block_map_implicit_key(inp); },
            ^Res(Input inp){ return e_node(inp); }}); }); },
        ^Res(Input inp){ return c_l_block_map_implicit_value(inp, n); }}); });
}

// [193] NS-S-BLOCK-MAP-IMPLICIT-KEY
Res ns_s_block_map_implicit_key(Input inp) {
    return peg_alt(inp, 1, (PFn[]){
        ^Res(Input inp){ return c_s_implicit_json_key(inp, @"BLOCK-KEY"); },
        ^Res(Input inp){ return ns_s_implicit_yaml_key(inp, @"BLOCK-KEY"); }});
}
...
Res c_l_block_map_implicit_value(Input inp, int n) {
    return peg_seq(inp, 1, (PFn[]){
        ^Res(Input inp){ return match_cp(inp, 58); },
        ^Res(Input inp){ return peg_alt(inp, 1, (PFn[]){
            ^Res(Input inp){ return s_lblock_node(inp, n, @"BLOCK-OUT"); },
            ^Res(Input inp){ return scalar(inp, ^Res(Input inp){ return peg_seq(inp, 1, (PFn[]){
                ^Res(Input inp){ return e_node(inp); },
                ^Res(Input inp){ return s_l_comments(inp); }}); }); }}); }});
}
...
Res ns_l_compact_mapping(Input inp, int n) {
    return peg_seq(inp, 1, (PFn[]){
        ^Res(Input inp){ return ns_l_block_map_entry(inp, n); },
        ^Res(Input inp){ return star(inp, ^Res(Input inp){ return peg_seq(inp, 1, (PFn[]){
            ^Res(Input inp){ return s_indent(inp, n); },
            ^Res(Input inp){ return ns_l_block_map_entry(inp, n); }}); }); }});
}
...
Res s_lblock_node(Input inp, int n, NSString *c) {
    return peg_alt(inp, 1, (PFn[]){
        ^Res(Input inp){ return s_lblock_in_block(inp, n, c); },
        ^Res(Input inp){ return s_lflow_in_block(inp, n); }});
}

// [197] S-L+FLOW-IN-BLOCK
Res s_lflow_in_block(Input inp, int n) {
    return peg_seq(inp, 1, (PFn[]){
        ^Res(Input inp){ return s_separate(inp, (n + 1), @"FLOW-OUT"); },
        ^Res(Input inp){ return ns_flow_node(inp, (n + 1), @"FLOW-OUT"); },
        ^Res(Input inp){ return s_l_comments(inp); }});
}
...
Res s_lblock_in_block(Input inp, int n, NSString *c) {
    return peg_alt(inp, 1, (PFn[]){
        ^Res(Input inp){ return s_lblock_scalar(inp, n, c); },
        ^Res(Input inp){ return s_lblock_collection(inp, n, c); }});
}

// [199] S-L+BLOCK-SCALAR
Res s_lblock_scalar(Input inp, int n, NSString *c) {
    return peg_seq(inp, 1, (PFn[]){
        ^Res(Input inp){ return s_separate(inp, (n + 1), c); },
        ^Res(Input inp){ return opt(inp, ^Res(Input inp){ return peg_seq(inp, 1, (PFn[]){
            ^Res(Input inp){ return c_ns_properties(inp, (n + 1), c); },
            ^Res(Input inp){ return s_separate(inp, (n + 1), c); }}); }); },
        ^Res(Input inp){ return peg_alt(inp, 1, (PFn[]){
            ^Res(Input inp){ return c_lliteral(inp, n); },
            ^Res(Input inp){ return c_lfolded(inp, n); }}); }});
}
...
Res s_lblock_collection(Input inp, int n, NSString *c) {
    return peg_seq(inp, 1, (PFn[]){
        ...
        ^Res(Input inp){ return s_l_comments(inp); },
        ^Res(Input inp){ return peg_alt(inp, 1, (PFn[]){
            ^Res(Input inp){ return lblock_sequence(inp, seq_spaces(n, c)); },
            ^Res(Input inp){ return lblock_mapping(inp, n); }}); }});
}

// [202] L-DOCUMENT-PREFIX
Res l_document_prefix(Input inp) {
    return peg_seq(inp, 1, (PFn[]){
        ^Res(Input inp){ return opt(inp, ^Res(Input inp){ return c_byte_order_mark(inp); }); },
        ^Res(Input inp){ return star(inp, ^Res(Input inp){ return l_comment(inp); }); }});
}
...
Res l_document_suffix(Input inp) {
    return peg_seq(inp, 1, (PFn[]){
        ^Res(Input inp){ return c_document_end(inp); },
        ^Res(Input inp){ return s_l_comments(inp); }});
}
...
Res c_forbidden(Input inp) {
    return peg_seq(inp, 1, (PFn[]){
        ^Res(Input inp){ return sol(inp); },
        ^Res(Input inp){ return peg_alt(inp, 1, (PFn[]){
            ^Res(Input inp){ return c_directives_end(inp); },
            ^Res(Input inp){ return c_document_end(inp); }}); },
        ^Res(Input inp){ return peg_alt(inp, 1, (PFn[]){
            ^Res(Input inp){ return b_char(inp); },
            ^Res(Input inp){ return s_white(inp); },
...
Res l_explicit_document(Input inp) {
    return build(inp, "DOC", ^Res(Input inp){ return peg_seq(inp, 1, (PFn[]){
        ^Res(Input inp){ return c_directives_end(inp); },
        ^Res(Input inp){ return peg_alt(inp, 1, (PFn[]){
            ^Res(Input inp){ return l_bare_document(inp); },
            ^Res(Input inp){ return peg_seq(inp, 1, (PFn[]){
                ^Res(Input inp){ return e_node(inp); },
                ^Res(Input inp){ return s_l_comments(inp); }}); }}); }}); });
}
...
Res l_directive_document(Input inp) {
    return peg_seq(inp, 1, (PFn[]){
        ^Res(Input inp){ return plus_(inp, ^Res(Input inp){ return l_directive(inp); }); },
        ^Res(Input inp){ return l_explicit_document(inp); }});
}

// [210] L-ANY-DOCUMENT
Res l_any_document(Input inp) {
    return peg_alt(inp, 1, (PFn[]){
        ^Res(Input inp){ return l_directive_document(inp); },
        ^Res(Input inp){ return l_explicit_document(inp); },
        ^Res(Input inp){ return l_bare_document(inp); }});
}
...
// [211] L-YAML-STREAM
Res l_yaml_stream(Input inp) {
    return build(inp, "STREAM", ^Res(Input inp){ return peg_seq(inp, 1, (PFn[]){
        ^Res(Input inp){ return star(inp, ^Res(Input inp){ return l_document_prefix(inp); }); },
        ^Res(Input inp){ return opt(inp, ^Res(Input inp){ return l_any_document(inp); }); },
        ^Res(Input inp){ return star(inp, ^Res(Input inp){ return peg_alt(inp, 1, (PFn[]){
            ^Res(Input inp){ return peg_seq(inp, 1, (PFn[]){
                ^Res(Input inp){ return plus_(inp, ^Res(Input inp){ return l_document_suffix(inp); }); },
                ^Res(Input inp){ return star(inp, ^Res(Input inp){ return l_document_prefix(inp); }); },
                ^Res(Input inp){ return opt(inp, ^Res(Input inp){ return l_any_document(inp); }); }}); },
            ^Res(Input inp){ return peg_seq(inp, 1, (PFn[]){
                ^Res(Input inp){ return star(inp, ^Res(Input inp){ return l_document_prefix(inp); }); },
                ^Res(Input inp){ return opt(inp, ^Res(Input inp){ return l_explicit_document(inp); }); }}); }}); }); }}); });
}
