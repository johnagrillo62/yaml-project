...
function s_indent_lt($inp, $n) {
    return (star(inp, { param($inp) s_space(inp) }.GetNewClosure()))
}
...
function c_nb_comment_text($inp) {
    return (peg_seq $inp @(
        { param($inp) c_comment(inp) }.GetNewClosure(),
        { param($inp) star(inp, { param($inp) nb_char(inp) }.GetNewClosure()) }.GetNewClosure()))
}
...
function s_l_comments($inp) {
    return (peg_seq $inp @(
        ...
        { param($inp) star(inp, { param($inp) l_comment(inp) }.GetNewClosure()) }.GetNewClosure()))
}
...
function ns_reserved_directive($inp) {
    return (peg_seq $inp @(
        ...
        { param($inp) star(inp, { param($inp) peg_seq $inp @(
            { param($inp) s_separate_in_line(inp) }.GetNewClosure(),
...
function c_ns_local_tag_prefix($inp) {
    return (peg_seq $inp @(
        { param($inp) match_cp(inp, 33) }.GetNewClosure(),
        { param($inp) star(inp, { param($inp) ns_uri_char(inp) }.GetNewClosure()) }.GetNewClosure()))
}
...
function nb_double_one_line($inp) {
    return (star(inp, { param($inp) nb_double_char(inp) }.GetNewClosure()))
}

# [112] S-DOUBLE-ESCAPED 
function s_double_escaped($inp, $n) {
    return (peg_seq $inp @(
        { param($inp) star(inp, { param($inp) s_white(inp) }.GetNewClosure()) }.GetNewClosure(),
        { param($inp) match_cp(inp, 92) }.GetNewClosure(),
        { param($inp) b_non_content(inp) }.GetNewClosure(),
        { param($inp) star(inp, { param($inp) l_empty(inp, $n, "FLOW-IN") }.GetNewClosure()) }.GetNewClosure(),
        { param($inp) s_flow_line_prefix(inp, $n) }.GetNewClosure()))
}
...
function nb_ns_double_in_line($inp) {
    return (star(inp, { param($inp) peg_seq $inp @(
        { param($inp) star(inp, { param($inp) s_white(inp) }.GetNewClosure()) }.GetNewClosure(),
    ...
    return (peg_seq $inp @(
        ...
        { param($inp) opt(inp, { param($inp) peg_seq $inp @(
            ...
            { param($inp) peg_alt $inp @(
                ...
                { param($inp) star(inp, { param($inp) s_white(inp) }.GetNewClosure()) }.GetNewClosure()) }.GetNewClosure()) }.GetNewClosure()) }.GetNewClosure()))
}
...
function nb_double_multi_line($inp, $n) {
    return (peg_seq $inp @(
        ...
        { param($inp) peg_alt $inp @(
            { param($inp) s_double_next_line(inp, $n) }.GetNewClosure(),
            { param($inp) star(inp, { param($inp) s_white(inp) }.GetNewClosure()) }.GetNewClosure()) }.GetNewClosure()))
}
...
function nb_single_one_line($inp) {
    return (star(inp, { param($inp) nb_single_char(inp) }.GetNewClosure()))
}
...
function ns_plain($inp, $n, $c) {
    return (scalar(inp, { param($inp) switch (c) {
...
function ns_plain_multi_line($inp, $n, $c) {
    return (peg_seq $inp @(
        ...
        { param($inp) star(inp, { param($inp) s_ns_plain_next_line(inp, $n, $c) }.GetNewClosure()) }.GetNewClosure()))
}
...
function l_keep_empty($inp, $n) {
    return (peg_seq $inp @(
        { param($inp) star(inp, { param($inp) l_empty(inp, $n, "BLOCK-IN") }.GetNewClosure()) }.GetNewClosure(),
        { param($inp) opt(inp, { param($inp) l_trail_comments(inp, $n) }.GetNewClosure()) }.GetNewClosure()))
}
...
function l_literal_content($inp, $n, $t) {
    return (scalar(inp, { param($inp) peg_seq $inp @(
        { param($inp) opt(inp, { param($inp) peg_seq $inp @(
            { param($inp) l_nb_literal_text(inp, $n) }.GetNewClosure(),
            { param($inp) star(inp, { param($inp) b_nb_literal_next(inp, $n) }.GetNewClosure()) }.GetNewClosure(),
...
function l_yaml_stream($inp) {
    return (build(inp, "STREAM", { param($inp) peg_seq $inp @(
        { param($inp) star(inp, { param($inp) l_document_prefix(inp) }.GetNewClosure()) }.GetNewClosure(),
        { param($inp) opt(inp, { param($inp) l_any_document(inp) }.GetNewClosure()) }.GetNewClosure(),
        { param($inp) star(inp, { param($inp) peg_alt $inp @(
            { param($inp) peg_seq $inp @(
